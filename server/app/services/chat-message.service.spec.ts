...
describe("chat-message-service", () => {
    ...
    it("should send a message to all users if a new user is connected", () => {
    ...
    it("should not send a connection message to all users if a new user has no username", () => {
    ...
    it("should send a message if a difference is found in solo mode", () => {
    ...
    it("should send a message to all users if a best time solo is beaten", () => {
    ...
    it("should send a message to all users if a best time pvp is beaten", () => {
        const username: string = "username";
        const positionIndex: number = 1;
        const gameName: string = "Voiture";
    ...
    it("should send a message if a difference is found in pvp mode", () => {
        ...
        .then((response: AxiosResponse<Message>) => {
            ...
            if (userSocket) {
                ...
                socketClient1.emit("errorIdentification", GameMode.Pvp, gameId);
        ...
        .then((response: AxiosResponse<Message>) => {
            ...
            try {
                ...
                if (userSocket) {
                    ...
                    socketClient1.emit("foundDifference", GameMode.Pvp, gameId);
